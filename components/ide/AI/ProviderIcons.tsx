...
export function OpenAIIcon({ size = 24, className }: ProviderIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GroqIcon({ size = 24, className }: ProviderIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AnthropicIcon({ size = 24, className }: ProviderIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GrokIcon({ size = 24, className }: ProviderIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function OpenRouterIcon({ size = 24, className }: ProviderIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function OllamaIcon({ size = 24, className }: ProviderIconProps) {
  return (
    <svg
      width={size}
      height={size}
